# launcher stub: the implementation is compiled in probe_alternating_gap_impl
import sys
import importlib.util as _u, pathlib as _p
try:
    import probe_alternating_gap_impl as _impl
except ImportError:
    _s = _u.spec_from_file_location("probe_alternating_gap_impl", next(_p.Path(__file__).resolve().parent.glob("probe_alternating_gap_impl.*.so")))
