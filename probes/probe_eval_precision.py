# launcher stub: the implementation is compiled in probe_eval_precision_impl
import sys
import importlib.util as _u, pathlib as _p
try:
    import probe_eval_precision_impl as _impl
except ImportError:
    _s = _u.spec_from_file_location("probe_eval_precision_impl", next(_p.Path(__file__).resolve().parent.glob("probe_eval_precision_impl.*.so")))
