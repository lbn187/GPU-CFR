# launcher stub: the implementation is compiled in overhead_probe_impl
import sys
import importlib.util as _u, pathlib as _p
try:
    import overhead_probe_impl as _impl
except ImportError:
    _s = _u.spec_from_file_location("overhead_probe_impl", next(_p.Path(__file__).resolve().parent.glob("overhead_probe_impl.*.so")))
